...
export default function InventoryStatusCardSkeleton() {
  return (
    <div role="status" aria-label="Loading inventory item status" className="p-4 rounded-lg border border-border dark:border-slate-800 bg-card dark:bg-slate-950 shadow-sm dark:shadow-md animate-pulse transition-colors">
