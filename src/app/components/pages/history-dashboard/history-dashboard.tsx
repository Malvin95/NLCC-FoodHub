            ...
            <div className="col-span-1 lg:col-span-2">
                <div className="w-full h-full">
                    ...
                    <Calendar 
                        ...
                        selected={date}
                        onSelect={setDate}
                        className="w-auto rounded-md border border-border bg-card p-3 shadow-sm dark:bg-slate-950 dark:border-slate-800 dark:shadow-md [--cell-size:auto]"
                    />
                    <div className="flex items-center gap-2 mt-3">
                        <div className="flex items-center gap-2">
                            <div className="w-4 h-4 bg-rose-50 border border-rose-200 rounded" />
                            <span className="text-sm text-gray-600">Volunteer Day</span>
                        </div>
                    </div>
                </div>
